                ...
                <div class="login_wrap">
                    <div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            <h3>بروز رسانی کردن اطلاعات راه ارتباطی </h3>
                        </div>
                        <?php
                        include "../connect.php";
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <input type="text" value="<?php echo $data->phone ?>" required="" class="form-control" name="phone" id="phone" placeholder=" شماره تلفن">
                            </div>
                            <div class="label-group">
                            ...
                            <div class="form-group">
                                <input type="text" value="<?php echo $data->email ?>" required="" class="form-control" name="email" id="email" placeholder="آدرس ایمیل">
                            </div>
                            <div class="label-group">
                            ...
                            <div class="form-group">
                                <input type="text" value="<?php echo $data->address ?>" required="" class="form-control" name="address" id="address" placeholder="آدرس محل کار">
                            </div>
                            <div class="form-group">
                                <button type="button" id="btn_update_contact" class="btn btn-fill-out btn-block btn_cat" name="register">ثبت اطلاعات</button>
                            </div>
                            <?php
                            }
                        else{
                            echo '<div class="empty_td">هیچ فرمی برای بروز رسانی وجود ندارد .</div>';
                        }
                            ?>
                        </div>
                    </div>
