        ...
        <div class="row align-items-center">
        	<div class="col-md-6">
                <div class="page-title">
            		<h1>شبکه ای نوار کناری سمت چپ</h1>
                </div>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">شبکه ای نوار کناری سمت چپ</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
                ...
                <div class="row shop_container">
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">لباس آبی زنانه</a></h6>
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">کت اسپرت خاکستری</a></h6>
                                <div class="product_price">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">لباس کامل زنانه</a></h6>
                                <div class="product_price">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">پیراهن آبی روشن</a></h6>
                                <div class="product_price">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">پیراهن چهارخونه</a></h6>
                                <div class="product_price">
                                    <span class="price">55000 تومان</span>
                                    <del>95000 تومان</del>
                                    <div class="on_sale">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">لباس زنانه</a></h6>
                                <div class="product_price">
                                    <span class="price">68000 تومان</span>
                                    <del>99000 تومان</del>
                                    <div class="on_sale">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">پیراهن جین آبی</a></h6>
                                <div class="product_price">
                                    <span class="price">69000 تومان</span>
                                    <del>89000 تومان</del>
                                    <div class="on_sale">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product">
                            ...
                            <div class="product_info">
                                <h6 class="product_title"><a href="shop-product-detail.php">تی شرت دخترانه</a></h6>
                                <div class="product_price">
                                    <span class="price">45000 تومان</span>
                                    <del>55000 تومان</del>
                                    <div class="on_sale">
                        ...
                        <ul class="list_brand">
                            <li>
                                <div class="custome-checkbox">
                                    ...
                                    <label class="form-check-label" for="Arrivals"><span>نایکی</span></label>
                                </div>
                            </li>
                            <li>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Lighting" value="">
                                    <label class="form-check-label" for="Lighting"><span>ریباک</span></label>
                                </div>
                            </li>
                            <li>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Tables" value="">
                                    <label class="form-check-label" for="Tables"><span>مانگو</span></label>
                                </div>
                            </li>
                            <li>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Chairs" value="">
                                    <label class="form-check-label" for="Chairs"><span>جی اوکس</span></label>
                                </div>
                            </li>
                            <li>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Accessories" value="">
                                    <label class="form-check-label" for="Accessories"><span>اسیکس</span></label>
                                </div>
                            </li>
                        </ul>
                    </div>
